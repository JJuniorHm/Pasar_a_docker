...
function insert_w(){
  ...
  $.ajax({
    type: "POST",
    url: "ajaxjs/warranty/insert_w.php",
      ...
      $("#containerwarrantycards .dns_ctinerclumn").sortable({
        ...
        receive: function(event, ui) {
          ...
          var columnNum = parseInt($(this).find(".dns_nberclumn").text());
            ...
            $.ajax({
            url: 'ajaxjs/warranty/updatestage.php',
            type: 'POST',
            dataType: 'json',
            data: {
              stage: stage,
...
function SarchTask(sarchtask){
  $.ajax({
    type: "POST",
    url: "ajaxjs/warranty/reloadkanban.php",
...
//Actualizar tarea
  ...
  function SearchClient(query) {
    $.ajax({
      type: 'POST',
      url: 'ajaxjs/warranty/searchclient.php',
      data: { query: query },
      dataType: 'JSON',
      success: function(response) {
        if(response.status){
...
$('#ccodcli').keydown(function(e) {
  ...
  function SearchCodigo(query) {
    $.ajax({
      type: 'POST',
      url: 'ajaxjs/warranty/searchcodigo.php',
      data: { query: query },
  ...
  function SearchDescripcion(query) {
    $.ajax({
      type: 'POST',
      url: 'ajaxjs/warranty/searchdescripcion.php',
      data: { query: query },
      success: function(data) {
        if(data.trim() === 'Sin resultados'){
  ...
  $("#button_openmodalinsert").click(function() {
    $('<div class="dns_backgroundmodal"></div>').insertBefore('#containermodalinsert').fadeIn();
    $("#containermodalinsert").toggleClass("open");
  });
...
$('#containermodalcarddetails').on( 'click', '#update_services_w',function(){
  $.ajax({
    type: "POST",
    url: "ajaxjs/warranty/update_service_w.php",
...
//Abre los detalles de las tareas
  ...
  $("#containerwarrantycards").on("dblclick", ".dns_cardkban", function() {
    $.ajax({
      type: "POST",
      url: "ajaxjs/warranty/carddetails.php",
...
$('#dstates').on('change', function() {
  $.ajax({
    type: 'POST',
    url: 'ajaxjs/warranty/update_state_w.php',
